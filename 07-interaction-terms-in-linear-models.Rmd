...
```{r fig.cap='Simple interaction plot - lines are not parallel'}
...
```{r fig.cap='interact_plot shows different slope for men and women'}
...
```{r fig.cap='ggplot automatically includes interaction'}
